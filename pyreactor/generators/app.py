...
from pyreactor.generators.backend.fastapi import FastAPIGenerator
from pyreactor.generators.backend.django import DjangoGenerator
from pyreactor.generators.backend.flask import FlaskGenerator
from pyreactor.generators.frontend import FrontendGenerator
from pyreactor.generators.devops import DevOpsGenerator
...
> Generated by [PyReactor](https://github.com/pyreactor/pyreactor) — Full-stack Python + React generator.
...
├── docker-compose.yml
├── Makefile
└── .pyreactor.json   # PyReactor project metadata
```
